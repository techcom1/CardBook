	...
	var wdw_cardbook = {
		...
		sortAccounts: function() {
			...
			for (var i = 0; i < listOfOpenedContainer.length; i++) {
				var cardbookPrefService = new cardbookPreferenceService(listOfOpenedContainer[i]);
   	...
   	loadFirstWindow: function () {
		...
		displayAccountOrCat: function (aCardList) {
			var accountsOrCatsTreeView = {
				...
				getCellText: function(row,column){
					if (column.id == "cardIcon") return aCardList[row].isAList;
				...
				if (params) {
					...
					if (composeFields) {
						...
						for (var i = 0; i < aListOfSelectedCard.length; i++) {
							...
							var myTempFile = Components.classes["@mozilla.org/file/local;1"].createInstance(Components.interfaces.nsILocalFile);
				...
				if (cardbookRepository.cardbookAccounts.length != 0) {
					...
					if (cardbookRepository.cardbookComplexSearchMode === "SEARCH") {
						wdw_cardbook.enableOrDisableElement(['toEmailCardsFromAccountsOrCats', 'ccEmailCardsFromAccountsOrCats', 'bccEmailCardsFromAccountsOrCats', 'shareCardsByEmailFromAccountsOrCats', 'cutCardsFromAccountsOrCats',
															...
															'printFromAccountsOrCats', 'renameCatFromAccountsOrCats', 'removeCatFromAccountsOrCats'], false);
		...
		enableCardCreation: function () {
			wdw_cardbook.enableOrDisableElement(['cardbookToolbarAddContactButton', 'cardbookToolbarAddListButton', 'cardbookContactsMenuAddContact', 'cardbookContactsMenuAddList', 'addContactFromCards', 'addListFromCards'], false);
		},
		...
		disableCardCreation: function () {
			wdw_cardbook.enableOrDisableElement(['cardbookToolbarAddContactButton', 'cardbookToolbarAddListButton', 'cardbookContactsMenuAddContact', 'cardbookContactsMenuAddList', 'addContactFromCards', 'addListFromCards'], true);
		},
